...
| **חברי העמדה** | מי יושב על העמדה במשמרת (`workstation_session_roles`). נרשם בעליית העמדה ומתעדכן מ"עדכון חברי העמדה" בתפריט המשתמש - אותו רכיב, `StationCrewForm` |
...
| **תפקיד מקצועי** | `positions` במיראז' (בקר / מש"ק / מפעיל) - **ציר נפרד מההרשאה**. קובע מאיזה תפריט אנשים כל שדה בטופס חברי העמדה נשאב. ריק = מופיע בכל התפריטים |
...
| **כח אדם** | תפקיד `manpower` במיראז' - פותח את מסך "כ"א ותחקירים" ב-LOGIN. הרשאת קריאה, לא הרשאת ניהול |
