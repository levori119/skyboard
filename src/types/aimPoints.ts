...
/**
 * מה שמוצג בשדה ריק. הפורמט המדויק שהשדה מצפה לו:
 * `N/S` + 4 ספרות + נקודה + 4 ספרות + `/` + `E/W` + 5 ספרות + נקודה + 4 ספרות.
 * הדגמה ולא תבנית ריקה - מספרים אמיתיים מלמדים כמה ספרות יש בכל מקטע.
 */
export const COORD_PLACEHOLDER = 'N3212.4500/E03456.8200';
