...
/**
 * גובה הפקדים, מידות החלון וסגנונות הטופס - מקור אמת אחד ב-`utils/windowForm.ts`,
 * משותף עם חלון "ניהול נסיעות" האח. מיוצאים מכאן בשמם ההיסטורי.
 */
export { CTRL_H, WINDOW_SIZE, formStyles };
