...
const SKIP_PATHS = [
  ...
  // סנכרון עבודה מנותקת: קליטת המראה מהמרכז והדחיפה חזרה אינן פעולה של מפעיל.
  // בלי זה כל סיבוב מראה היה יוצר פעולה במחסנית, ו-CTRL+Z היה "מבטל" את תמונת
  // המצב שהשרת זה עתה שלח. ראה server/routes/sync.js.
  /^\/api\/sync(\/|$)/,
];
