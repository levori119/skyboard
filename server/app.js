...
import joiningPointsRouter from './routes/joiningPoints.js';
...
import stripControlsRouter from './routes/stripControls.js';
...
import tempZoneSeizuresRouter from './routes/tempZoneSeizures.js';
import transferTakeoversRouter from './routes/transferTakeovers.js';
import stripFlowRouter   from './routes/stripFlow.js';
import screenRecordingRouter from './routes/screenRecording.js';
...
// שומרים גוף גולמי רק לנתיבי GAPI - נדרש לאימות חתימת ה-HMAC על הבייטים
// שנשלחו בפועל. מותנה בנתיב כדי לא להכפיל זיכרון על העלאות כבדות
// (תמונות/PDF של שאר ה-API).
...
app.use(stripFlowRouter);
app.use(screenRecordingRouter);
app.use(syncRouter);
app.use(localDbRouter);
app.use(sectorsRouter);
app.use(workstationsRouter);
app.use(airPictureRouter);
app.use(mapsRouter);
app.use(tempZoneSeizuresRouter);
app.use(transferTakeoversRouter);
app.use(blocksRouter);
app.use(airfieldRouter);
app.use(joiningPointsRouter);
app.use(baseRouter);
