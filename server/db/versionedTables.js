...
export const VERSIONED_TABLES = [
  ...
  // הערת העמדה על הפ"מ. נוספה אחרי שדווח שהערה שנכתבה בנתק אינה חוזרת
  // למרכז: היא נשמרה יפה במאגר המקומי, פשוט לא הייתה ברשימה הזו - ולכן איש
  // לא ידע לדחוף אותה. זהו בדיוק ה"אובדן השקט" שהיומן בא למנוע.
  'strip_station_notes',
];
