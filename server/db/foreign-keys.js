...
export const FOREIGN_KEYS = [
  ...
  ['airfield_permit_params', 'airfield_id', 'airfields', 'id', 'CASCADE'],
  ['airfield_permit_params', 'polygon_id', 'airfield_polygons', 'id', 'SET NULL'],
  ...
  ['entry_permit_drivers', 'airfield_id', 'airfields', 'id', 'CASCADE'],
  ['entry_permit_drivers', 'transport_role_id', 'airfield_permit_params', 'id', 'SET NULL'],
  ['entry_permit_driver_zones', 'driver_id', 'entry_permit_drivers', 'id', 'CASCADE'],
  ['entry_permit_driver_zones', 'zone_id', 'airfield_permit_params', 'id', 'CASCADE'],
  ['entry_permit_vehicles', 'driver_id', 'entry_permit_drivers', 'id', 'CASCADE'],
  ['entry_permit_vehicles', 'vehicle_type_id', 'airfield_permit_params', 'id', 'SET NULL'],
  ...
  ['strip_control_values', 'preset_id', 'workstation_presets', 'id', 'CASCADE'],
  ['strip_control_values', 'strip_id', 'strips', 'id', 'CASCADE'],
  ...
  ['vehicle_requests', 'permit_driver_id', 'entry_permit_drivers', 'id', 'SET NULL'],
