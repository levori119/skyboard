...
// ── במרכז: רשימת הטבלאות, כדי שהעמדה תמשוך אותן בחלקים ───────────────────────
//
// למה זה קיים: צילום **מלא** של 128 הטבלאות לוקח כ-10 שניות ומשקלו 4.6MB,
// והוא חרג מתקרת הזמן של הפרוקסי (8 שניות) - כלומר כל מראה נפלה ב-502
// והמאגר המקומי נשאר **ריק לנצח**. בנתק זה נראה כאילו כל הנתונים נעלמו.
// הרשימה מוחזרת בסדר התלויות, ולכן העמדה יכולה לחתוך אותה לקבוצות בלי לשבור
