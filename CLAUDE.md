...
| **מיקום** | בורר ויזואלי בתפריט "תצוגה": הכי שמאלי · צמוד למפה · בין הפ"מים לעזרים · הכי ימני. ה-`order` מגיע מ-`DOCK_POSITION_ORDER`, ועמודות השורה מקבלות ערכים אי-זוגיים (נקודות=1ż3 · מפה=2 · פ"מים=5 · עזרים=7) |
