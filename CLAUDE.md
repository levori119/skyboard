...
| **אזור סגור** | אזור מפה שאסור לאייש. נקבע בעמדה בלחיצה על **קו** האזור, ותמיד עם טווח גבהים (טווח ריק = כל הגבהים). ראה [`src/utils/zoneRestriction.ts`](src/utils/zoneRestriction.ts) |
| **אזור מוגבל** | כמו סגור, אבל מותנה: האיוש אפשרי ומוציא התראה כתומה ולא אדומה |
