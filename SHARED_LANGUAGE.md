...
**קישורי מסלולים (רובד ביישות שדה התעופה):** אותו מסלול פיזי נראה בכמה עמדות
ב**שמות שונים**. **קישור** מצהיר שהם אותו דבר, והוא **קבוצה** של עמדות (לא זוג) -
אפשר לקשר שלוש עמדות ומעלה. הקישור אינו שייך למסלולי הסעה: הוא חל על **כל** סוגי
המסלולים, כולל **מסלול המראה**.
